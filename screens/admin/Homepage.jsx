    ...
    <SafeAreaView style={styles.safeAreaView}>
      <ScrollView contentContainerStyle={styles.scrollView}>
        <View style={styles.viewContainer}>
          ...
          <Text style={[styles.reservationTitle, { marginBottom: 0 }]}>
            Your reservation
          </Text>
          ...
          <View style={styles.assistMain}>
            <View style={styles.assistWrap}>
              ...
              />
              <View>
                <Text style={styles.assistHeader}>Talk to your assistant</Text>
                <Text style={styles.assistContent}>
                  You need help? Please contact to your assistant to know more
            ...
            <View style={styles.assistWrap}>
              ...
              <View>
                ...
                <Text style={[styles.assistContent]}>
                  As a new owner, you can contact to the group of assistants who
                  have been trained.
                </Text>
              </View>
            </View>
