                    ...
                    <View style={styles.viewContainer}>
                        ...
                        <View style={styles.container}>
                            ...
                            <Text style={styles.subText}>
                                Price for customer (before tax) <Text style={styles.subPrice}>{subPrice} US$</Text>
                            </Text>
                        </View>   

                        <View style={styles.containerNotifi}>
                            <Icon name="location-on" size={24} color="#3A69A8" style={styles.icon} />
                            <Text style={styles.text}>
                                Compare similar houses/rooms for rent within the price range of <Text style={styles.priceNotifi}>$18-$26</Text>
                            </Text>
                        </View>               
                    </View>
