    ...
    <ScrollView style={styles.container}>
      <View style={styles.messageContainer}>
        ...
        <Text style={styles.message}>
          Hello, my name is Hanh and I find your apartment quite interesting. Is
          your apartment habitable all year round?
        </Text>
      ...
      <View style={[styles.messageContainer, styles.receiverContainer]}>
        ...
        <Text style={styles.message}>
          Of course, my apartment is open all year round and you can rent it
          long term.
        </Text>
        <Text style={styles.timestamp}>05/06/2024</Text>
      </View>
      ...
      <View style={[styles.messageContainer, styles.receiverContainer]}>
        <Text style={styles.senderName}>You</Text>
        <Text style={styles.message}>
          May I ask some more information about your apartment?
        </Text>
        <Text style={styles.timestamp}>05/06/2024</Text>
      </View>
    </ScrollView>
