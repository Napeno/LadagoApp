      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.amenityItemDetail}>
          ...
          <View style={styles.amenityDetailText}>
            <Text style={styles.amenityText}>Parking</Text>
            <Text style={styles.amenityDescription}>
              Free parking lot (1 slot per group)
            </Text>
          </View>
        </View>
        <View style={styles.divider} />
        ...
        <View style={styles.amenityItemDetail}>
          ...
          <View style={styles.amenityDetailText}>
            ...
            <Text style={styles.amenityDescription}>
              Restaurant which serve the best seafood
            </Text>
            <Text style={styles.amenityDescription}>
              Hotel bar has drinks for child and non-alcohol
            </Text>
          </View>
        </View>
        <View style={styles.divider} />
        ...
        <View style={styles.amenityItemDetail}>
          ...
          <View style={styles.amenityDetailText}>
            ...
            <Text style={styles.amenityDescription}>
              Cameras at hotel hall that work 24/7
            </Text>
            <Text style={styles.amenityDescription}>
              Security guards available 24/24
            </Text>
          </View>
        </View>
        <View style={styles.divider} />
        <View style={styles.amenityItemDetail}>
          ...
          <View style={styles.amenityDetailText}>
            ...
            <Text style={styles.amenityDescription}>
              Our hotel room has kitchen for basic cooking
            </Text>
        ...
        <View style={styles.amenityItemDetail}>
          ...
          <View style={styles.amenityDetailText}>
            ...
            <Text style={styles.amenityDescription}>
              Outdoor public swimming pool available 24/24
            </Text>
            <Text style={styles.amenityDescription}>
              Gym and spa available in the afternoon
            </Text>
          </View>
        </View>
        <View style={styles.divider} />
